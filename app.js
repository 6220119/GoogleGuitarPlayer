...
(function (window) {
  ...
  document.getElementById('gg-guitar-frame').onload = function onIframeLoaded() {
    ...
    function shareOnFb() {
      window.open('https://www.facebook.com/sharer/sharer.php?u=' + getShareUrl(), 'fbShareWindow', 'height=450, width=550, top=' + (window.innerHeight / 2 - 275) + ', left=' + (window.innerWidth / 2 - 225) + ', toolbar=0, location=0, menubar=0, directories=0, scrollbars=0');
    }
